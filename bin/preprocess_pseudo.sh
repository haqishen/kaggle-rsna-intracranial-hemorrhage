# pseudo
python -m src.postprocess.make_pseudo --input /data/data/RSNA/new30fold.csv --output /data/src/kaggle-rsna-intracranial-hemorrhage/exp/effnet_b3_512_p2/pseudo.csv
