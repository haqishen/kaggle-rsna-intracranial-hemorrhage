...
# pseudo
python -m src.postprocess.make_pseudo --input /data/src/kaggle-rsna-intracranial-hemorrhage/exp/effnet_b3_512_p2/effnet_b3_512_p2_5fold_5tta.csv --output /data/src/kaggle-rsna-intracranial-hemorrhage/exp/effnet_b3_512_p2/pseudo.csv
